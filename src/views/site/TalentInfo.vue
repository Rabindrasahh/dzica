<template>
  <div>
            ...
            <div class="col-md-5">
              <div class="profile-card">
                <div class="profile-card-img">
                  ...
                  />
                  <img v-else src="../../assets/img/user-placeholder.png" />
                </div>
              </div>
            </div>
            <div class="col-md-7">
              <div class="profile-card">
                <div class="rates_like">
                  <div class="rates">
                    <li>
                ...
                <h1>{{ talent.name }}</h1>
                <h4>{{ talent.categoryId?.name }}</h4>
                <span
                  ><i class="fa fa-bolt" aria-hidden="true"></i> Delivery in 48
                  hours</span
                >
                <p>
                  {{ talent.description }}
                ...
                <h6>Pricing</h6>
                <h3>{{ talent.normalPrice }} DA</h3>
                <!-- <div class="personal-use">
                  <div class="personal-use-card">
                    <router-link
                      :to="{
                  ...
                  <p>Personalized video for you or someone else</p>
                </div>
                <div class="personal-use">
                  <div class="personal-use-card">
                    <h6>For business</h6>
                    ...
                    >
                      <h6>For business</h6>
                      <h6>{{ talent.marketingPrice }} DA</h6>
                      (Marketing)
                      <i class="fas fa-arrow-right text-xs"></i>
                    </router-link>
                  ...
                  <p>
                    Engaging video content for your company,<br />customers, or
                    employees.
                  </p>
                </div> -->
                <div class="personal-use" v-on:click="Personal">
                  <div class="personal-use-card">
                    <h6>Personal use</h6>
                    <h6>{{ talent.normalPrice }}DA</h6>
                  </div>
                ...
                <div class="personal-use" v-bind="talent.marketingPrice">
                  <div class="personal-use-card">
                    <h6>For business</h6>
                    <h6>{{ talent.marketingPrice }} DA</h6>
                  </div>
                ...
                <button type="submit" v-if="talent.normalPrice">
                  Book now DA {{ talent.normalPrice }}
                </button>
                <button type="submit" v-if="talent.marketingPrice">
                  Book now DA {{ talent.marketingPrice }}
                </button>

                <!-- <button type="button">Book now DA 6,000</button> -->
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="how-it-works-card">
                <img src="../../assets/img/hiw.png" />
                <h4>Place your order</h4>
                <p>
                  Add all the information necessary for the talent to best
            ...
            <div class="col-md-12">
              <div class="hiw-text">
                <h6>#TIP</h6>
                <h3>What does a good request look like?</h3>
                <span
                  >Try to be as specific as possible with your request such as
                  your relationship to the Dzicace recipient, numbers & details.
                  Ex. "tell my BFF Cam congrats on graduating from USTHB."</span
                >
              </div>
            </div>
          </div>
    ...
    <div class="reviews">
      <div class="container">
        <div class="inner-t-profile">
          <h2 class="heading1">Recent reviews</h2>
...
#Viewallreviews .modal-body::-webkit-scrollbar {
  width: 10px;
}
#Viewallreviews .modal-body::-webkit-scrollbar-track {
  box-shadow: inset 0 0 10px #112848;
}
#Viewallreviews .modal-body::-webkit-scrollbar-thumb {
  background: #c4c4c4;
  border-radius: 10px;
}
.inner-business-form form {
  padding: 0px 50px;
}
.inner-business-form h3 {
  background: #0e284e;
  color: #fff;
  font-size: 14px;
  padding: 15px 10px;
...
.inner-business-form input::placeholder {
  color: #8aa5cb;
}
.inner-business-form textarea::placeholder {
  color: #8aa5cb;
}
.inner-business-form label {
  color: #b2c7e3;
  font-size: 15px;
  font-weight: 400;
}
.inner-business-form input {
  border: 1px solid #4a6c9b;
  background: transparent !important;
  color: #8aa5cb !important;
  padding: 25px 15px;
...
.inner-terms-and-condition {
  width: 70%;
  margin: auto;
}
.inner-terms-and-condition p a {
  color: #7a7a7a;
  text-decoration: none;
}
.inner-terms-and-condition p {
  color: #7a7a7a;
  font-size: 15px;
  font-weight: 500;
}
.inner-terms-and-condition h2 {
  font-weight: 800;
  color: #061428;
  padding: 20px 0px;
}
